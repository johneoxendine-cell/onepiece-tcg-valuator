...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://optcgmarket.com/</loc>
    <lastmod>${today}</lastmod>
    <changefreq>daily</changefreq>
    <priority>1.0</priority>
  </url>
  <url>
    <loc>https://optcgmarket.com/cards</loc>
    <lastmod>${today}</lastmod>
    <changefreq>daily</changefreq>
    <priority>0.9</priority>
  </url>
  <url>
    <loc>https://optcgmarket.com/sealed</loc>
    <lastmod>${today}</lastmod>
    <changefreq>daily</changefreq>
    <priority>0.8</priority>
  </url>`;

    // Add each set as a URL
    for (const set of sets) {
      sitemap += `
  <url>
    <loc>https://optcgmarket.com/cards?set_id=${encodeURIComponent(set.id)}</loc>
    <lastmod>${today}</lastmod>
    <changefreq>daily</changefreq>
